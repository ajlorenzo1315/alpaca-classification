...
for prompt in tqdm.tqdm(prompts,desc="promting"):
    ...
    guardar_en_csv('resultados_llm1.csv', datos_a_guardar_1)   
    guardar_en_csv('resultados_llm2.csv', datos_a_guardar_2)   
    guardar_en_csv('resultados_rag1.csv', datos_a_guardar_3)   
