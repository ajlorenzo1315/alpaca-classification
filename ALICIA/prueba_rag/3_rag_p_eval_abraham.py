...
for prompt in tqdm.tqdm(prompts,desc="promting"):
    ...
    guardar_en_json('resultados_llm1_2.csv', datos_a_guardar_1)   
    guardar_en_json('resultados_llm2_2.csv', datos_a_guardar_2)   
    guardar_en_json('resultados_rag1_2.csv', datos_a_guardar_3)   
