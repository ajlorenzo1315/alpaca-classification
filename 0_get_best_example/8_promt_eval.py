...
log_filename = "llama_eval_log_best_new.txt"
...
select_example={'student':968,'department':137,'faculty':602,'course':682,'project':186,'staff':37}
examples_to_promt=[]
...
for prompt in tqdm.tqdm(prompts,desc="promting"):
    ...
    guardar_en_json(f'./staff_student/resultados_llm2_supost_beter_{class_selected}_{model_name}.json', datos_a_guardar_1)
