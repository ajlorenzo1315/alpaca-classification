...
keys_wod=get_all_keys('../data_extrac/keys/',7)
print(keys_wod)
...
log_filename = "llama_eval_log_more_bes_evalt.txt"
...
for indx,prompt in tqdm.tqdm(enumerate(prompts),desc="promting"):
    ...
    guardar_en_json(f'./staff_student/eval_llm2_reduce_beter_{class_selected}_{model_name}.json', datos_a_guardar_1)
