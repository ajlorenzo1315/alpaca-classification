...
llm = LlamaLLM(model_path=model_path,n_ctx=4096,n_gpu_layers=15)
#print(llm(promt))
#
#
##test,promt_test,a,c=get_all_files('../data/splits/test_new_data',-1)
test,promt_test,a,c=get_all_files('../data/splits/train_new_data',2)
...
#    guardar_en_csv('resultados_llm1_2.csv', datos_a_guardar_1)   
    guardar_en_csv('resultados_llm2_promt_2_model_70.csv', datos_a_guardar_1) 
    guardar_en_json('resultados_llm2_promt_2_model_70.json', datos_a_guardar_1)
    guardar_en_json('resultados_llm2_not_promt_2_model_70.json', datos_no_promting)   
